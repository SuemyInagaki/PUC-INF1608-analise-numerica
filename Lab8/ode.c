...
double RungeKutta (double t0, double t1, double h, double y0, double (*f) (double t, double y)){
    ...
    printf("n de iteracoes = %d\n", i/4);
    return y;
}


double* oneStep(double t, double y, double h, double (*f) (double t, double y), double tol, int* i){
    double a[6] = {0, 1.0/5.0, 3.0/10.0, 3.0/5.0, 1.0, 7.0/8.0};
    double b[6][5] = {{0, 0, 0, 0, 0}, {1.0/5.0, 0, 0, 0, 0}, {3.0/40.0, 9.0/40.0, 0, 0, 0}, {3.0/10.0, -9.0/10.0, 6.0/5.0, 0, 0}, {-11.0/54.0, 5.0/2.0, -70.0/27.0, 35.0/27.0, 0}, {1631.0/55296.0, 175.0/512.0, 575.0/13824.0, 44275.0/110592.0, 253.0/4096.0}};
    ...
    double y_, delta, y1, fator, k1, k2, k3, k4, k5, k6;
    k1 = h*f(t, y);
